...
\textit{Caenorhabditis elegans}\footnote{Wormbase Release WS160
  \url{http://www.wormbase.org}. see Rizzon C, Martin E, Marais G, Duret L, Segalat L, Biemont C. 
...
Column names must be in the first row and values must be separated by space or tab.\\
